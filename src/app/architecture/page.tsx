  ...
  return (
    <div className={styles.default}>
      <div className={styles.intro}>
        <small className={styles.introPretitle}>Interiors, Architecture</small>
        <h1 className={styles.introTitle}>The Unfolding Home</h1>
        <h2 className={styles.introAuthor}>Words by Jillian Japka</h2>
      </div>
      ...
      <main className={styles.editor}>
        ...
        <figure className={styles.imgFigure}>
          <div
            className={styles.imgWrapper}
            data-orientation="portrait"
            style={{ paddingBottom: "149.91666666667%" }}
          >
            <Image
              alt=""
              className={styles.img}
        ...
        <figure className={styles.imgFigure}>
          <div
            className={styles.imgWrapper}
            data-orientation="portrait"
            style={{ paddingBottom: "150.08333333333%" }}
          >
            <Image
              alt=""
              className={styles.img}
      ...
      <section className={styles.meta}>
        <dl className={styles.metaContent}>
          <dt className={styles.metaTitle}>Location</dt>
          <dd className={styles.metaText}>Słupsk, Poland</dd>

          <dt className={styles.metaTitle}>Architecture</dt>
          <dd className={styles.metaText}>
            <a href="http://acos.design/">ACOS</a>
          </dd>

          <dt className={styles.metaTitle}>Website</dt>
          <dd className={styles.metaText}>
            <a href="http://acos.design/">acos.design</a>
          </dd>

          <dt className={styles.metaTitle}>Photography</dt>
          <dd className={styles.metaText}>PION Studio</dd>
        </dl>
      </section>
    </div>
  );
